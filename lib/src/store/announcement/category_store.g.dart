...
mixin _$CategoryStore on _CategoryStore, Store {
  Computed<List<Category>> _$allCategoriesComputed;

  @override
  List<Category> get allCategories => (_$allCategoriesComputed ??=
          Computed<List<Category>>(() => super.allCategories,
              name: '_CategoryStore.allCategories'))
      .value;
  ...
  @override
  dynamic setError(String newError) {
